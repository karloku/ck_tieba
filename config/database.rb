...
database_name = case Padrino.env
  when :development then 'ck_tieba_development'
  when :production  then 'ck_tieba_production'
  when :test        then 'ck_tieba_test'
end
...
#     sessions:
#       default:
#         database: ck_tieba_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: ck_tieba_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: ck_tieba_test
#         hosts:
#           - localhost:27017
#
#
